...
EXAM_MATERIALS = [
    ...
    (55, "국어", "2024학년도 1학기 중간고사 국어", "기출문제", 2024, "1학기",
     "황금중학교 국어 중간고사. 문학(현대소설)+문법. 지학사 교과서."),
    (55, "영어", "2025학년도 1학기 기말고사 영어", "기출문제", 2025, "1학기",
     "황금중 영어 기말고사. 비교급+최상급+가정법. 동아출판 교과서."),

    # ----- 인천 -----
    (63, "영어", "2024학년도 2학기 중간고사 영어", "기출문제", 2024, "2학기",
     "인천외고 영어 중간고사. 영문학+고급작문. 에세이형 2문항 포함."),
    (63, "사회", "2025학년도 1학기 중간고사 세계사", "기출문제", 2025, "1학기",
     "인천외고 세계사 중간고사. 프랑스혁명~산업혁명. 미래엔 교과서."),

    (65, "국어", "2024학년도 1학기 중간고사 국어", "기출문제", 2024, "1학기",
     "송도중학교 국어 중간고사. 문학(시+소설)+독서. 지학사 교과서."),
    (65, "수학", "2025학년도 1학기 기말고사 수학", "기출문제", 2025, "1학기",
     "송도중 수학 기말고사. 도형의 닮음+피타고라스. 서술형 5문항."),

    # ----- 광주 -----
    (71, "수학", "2024학년도 1학기 중간고사 수학", "기출문제", 2024, "1학기",
     "광주과학고 수학 중간고사. 행렬+벡터 기초. 비상교육 심화 교재."),

    (73, "국어", "2024학년도 2학기 중간고사 국어", "기출문제", 2024, "2학기",
     "광주중앙중학교 국어 중간고사. 비문학(인문·예술)+문법. 천재교육 교과서."),

    # ----- 대전 -----
    (79, "과학", "2024학년도 1학기 중간고사 화학Ⅰ", "기출문제", 2024, "1학기",
     "대전과학고 화학Ⅰ 중간고사. 원자구조+화학결합. 심화 계산형 10문항."),
    (79, "수학", "2025학년도 1학기 중간고사 수학", "기출문제", 2025, "1학기",
     "대전과학고 수학 중간고사. 미적분+공간도형. 비상교육 심화."),

    (82, "영어", "2024학년도 1학기 기말고사 영어", "기출문제", 2024, "1학기",
     "대전가오중학교 영어 기말고사. 간접의문문+분사구문. 지학사 교과서."),
    (82, "사회", "2025학년도 1학기 중간고사 사회", "기출문제", 2025, "1학기",
     "대전가오중 사회 중간고사. 경제(시장+수요공급)+문화. 동아출판 교과서."),

    # ----- 울산 -----
    (87, "한국사", "2024학년도 2학기 기말고사 한국사", "기출문제", 2024, "2학기",
     "울산과학고 한국사 기말고사. 근현대사 통합. 주제별 에세이 2문항 포함."),

    # ----- 세종 -----
    (92, "영어", "2025학년도 1학기 중간고사 영어", "기출문제", 2025, "1학기",
     "새롬중학교 영어 중간고사. to부정사+동명사. 미래엔 교과서."),
    (92, "수학", "2024학년도 1학기 기말고사 수학", "기출문제", 2024, "1학기",
